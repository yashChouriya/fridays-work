        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400 max-w-xs">
              Transforming lives through fitness since 2010. Join our community and forge your best self.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/classes" className="text-gray-400 hover:text-primary transition-colors">Classes</Link>
              </li>
              <li>
                <Link to="/trainers" className="text-gray-400 hover:text-primary transition-colors">Trainers</Link>
              </li>
              <li>
                <Link to="/subscriptions" className="text-gray-400 hover:text-primary transition-colors">Subscriptions</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400 flex items-start">
                ...
                <span>123 Fitness Avenue, Workout City, FC 12345</span>
              </li>
              <li className="text-gray-400 flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} FitnessForge. All rights reserved.
            </p>
